...
Se implementa un modelo de sesi\'{o}n en backend que encapsula configuraci\'{o}n, calibraci\'{o}n, temperatura, identificador de muestra, tipo de ensayo, datos punto a punto, eventos de protocolo y salida de clasificadores. Cada barrido finalizado genera artefactos exportables en formatos complementarios (CSV, JSON y resumen textual), permitiendo auditor\'{i}a t\'{e}cnica y uso posterior en pipelines de aprendizaje.
...
\begin{itemize}
	...
	\item Asociar metadatos de configuraci\'{o}n, calibraci\'{o}n, temperatura, identificador de muestra y tipo de ensayo.
...
\begin{itemize}
	...
	\item Identidad experimental: identificador de muestra (\texttt{sample\_id}) y tipo de ensayo (\texttt{control}, \texttt{sham}, \texttt{em\_dc}).
...
\begin{table}[ht]
	...
	\begin{tabular}{l p{8.8cm}}
		...
		\texttt{<id>\_metadata.json} & Metadatos de sesi\'{o}n, \texttt{sample\_id}, \texttt{assay\_type}, eventos y resultado de clasificaci\'{o}n.        \\
...
\begin{itemize}
	\item Identificador de muestra y tipo de ensayo experimental.
...
\begin{itemize}
	...
	\item Registro expl\'{i}cito de \texttt{sample\_id} y \texttt{assay\_type} para cubrir trazabilidad experimental Control/Sham/EM DC.
